...
const API_ENDPOINT = {
  ...
  DAFTAR_HADIST: () => `${CONFIG.BASE_URL_HADIST}/books`,
  // HADIST_NUMBER : (name, number) => `${CONFIG.BASE_URL_HADIST}/books/${name}?range=${number}-${number}`,
  // HADIST_SPESIFIK : (name) => `${CONFIG.BASE_URL_HADIST}/books/${name}/${number}`,
};
